...
require 'orient-commons-1.7.4.jar'
require 'orientdb-client-1.7.4.jar'
require 'orientdb-core-1.7.4.jar'
require 'orientdb-distributed-1.7.4.jar'
require 'orientdb-enterprise-1.7.4.jar'
require 'orientdb-graphdb-1.7.4.jar'
require 'orientdb-nativeos-1.7.4.jar'
require 'orientdb-object-1.7.4.jar'
require 'orientdb-server-1.7.4.jar'
