...
require 'orient-commons-1.7.4-SNAPSHOT.jar'
require 'orientdb-client-1.7.4-SNAPSHOT.jar'
require 'orientdb-core-1.7.4-SNAPSHOT.jar'
require 'orientdb-distributed-1.7.4-SNAPSHOT.jar'
require 'orientdb-enterprise-1.7.4-SNAPSHOT.jar'
require 'orientdb-graphdb-1.7.4-SNAPSHOT.jar'
require 'orientdb-nativeos-1.7.4-SNAPSHOT.jar'
require 'orientdb-object-1.7.4-SNAPSHOT.jar'
require 'orientdb-server-1.7.4-SNAPSHOT.jar'
